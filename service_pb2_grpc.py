...
class MyServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.ComputeGCD = channel.unary_unary(
                '/myservice.MyService/ComputeGCD',
...
def add_MyServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ComputeGCD': grpc.unary_unary_rpc_method_handler(
                    servicer.ComputeGCD,
...
class MyService(object):
    ...
    def ComputeGCD(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/myservice.MyService/ComputeGCD',
